...
const groupDefinitions = [
  ...
  },
  {
    ...
    items: ["личная работа со мной на протяжении всего обучения", "доступ в общий чат с единомышленниками", "собственная платформа для обучения", "еженедельные эфиры", "личный чат со мной", "стримы от выпускников, получивших оффер", "собственная практика, которая поднимается под тебя"],
  },
  {
    id: "guarantees",
    index: "04",
...
const anchorItems = new Set([
  ...
  "личная работа со мной на протяжении всего обучения",
