...
const groupDefinitions = [
  ...
  },
  {
    ...
    items: ["свой ментор на протяжении всего обучения", "доступ в общий чат с единомышленниками", "собственная платформа для обучения", "сессии с психологом", "еженедельные эфиры", "мини чат с твоим ментором и создателем этого проекта", "стримы от выпускников, получивших оффер", "собственная практика, которая поднимается под тебя"],
  },
  {
    id: "guarantees",
    index: "04",
