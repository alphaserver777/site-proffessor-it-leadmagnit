...
На 6 сентября 2026 года в production восстановлен проверенный выпуск
`ea833ac-20260826195939`. Он остаётся активным, пока независимая версия не
пройдёт проверку и не будет слита в `main`.
