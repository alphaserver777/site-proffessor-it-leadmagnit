...
data.settings.ui.ctaSubtitle = "Самостоятельно тоже можно. Вопрос — сколько времени займёт путь.\n\nМожно годами собирать материалы, менять курсы и пытаться понять, что делать дальше. В индивидуальной работе маршрут уже выстроен: от первого шага до оффера и поддержки на испытательном сроке.";
