...
data.settings.ui.ctaTitle = "Сейчас твой выбор";
data.settings.ui.ctaSubtitle = "Можно продолжать смотреть бесплатные курсы и учить инструменты без системы — потратить месяцы, но так и не приблизиться к трудоустройству.\n\nЕсть другой путь.\n\nВсё необходимое для выхода на оффер уже собрано в один маршрут: знания, практика, резюме, собеседования и поддержка после трудоустройства.\n\nВыбирай маршрут «Со мной», занимай одно из трёх мест — и начинаем.";
